...
public class PlatformServiceTests
{
    ...
    [Fact]
    public async Task CreateOrUpdatePlatformShouldUpdatePlatformWhenPlatformExists()
    {
        // Arrange
    ...
    [Fact]
    public async Task GetAllPlatformsAsyncShouldReturnPlatformDtosWhenPlatformsExist()
    {
        // Arrange
    ...
    [Fact]
    public async Task GetPlatformByIdShouldReturnPlatformDtoWhenPlatformExists()
    {
        // Arrange
        var platformId = Guid.NewGuid();
